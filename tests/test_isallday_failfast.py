...
class TestUpdateFailFast:
    def test_reminders_without_isallday_raises(self):
    ...
    def test_startdate_without_isallday_raises(self):
        with pytest.raises(ValueError, match="isAllDay must be passed explicitly"):
            _prepare_task(
    ...
    def test_duedate_without_isallday_raises(self):
        with pytest.raises(ValueError, match="isAllDay must be passed explicitly"):
            _prepare_task(
    ...
    def test_allday_true_with_positive_trigger_passes(self):
    ...
    def test_allday_true_with_negative_trigger_raises(self):
    ...
    def test_allday_false_with_positive_trigger_raises(self):
    ...
    def test_dateonly_duedate_implies_allday_no_failfast(self):
...
class TestCreateInference:
    def test_reminders_with_dateonly_infers_allday_true(self):
        task, _ = _prepare_task(
    ...
    def test_reminders_with_timeofday_infers_allday_false(self):
        task, _ = _prepare_task(
            {
                "title": "T",
                "brief": "B",
