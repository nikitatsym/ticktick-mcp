...
def _build_help(group_name: str) -> str:
    ...
    First docstring line becomes the op summary; the rest of the docstring is
    surfaced indented under the op. Non-type constraints (formats, conditional
    requirements, embedded-tag rules, opaque-string formats) live there so
    callers learn from help, not from error messages.
    """
